...
def train_treat_for_predict():
    ...
    df21 = pd.read_csv("./data/0808_train/treat/2021_202308081738.csv", header=0, sep=',', encoding='gbk')
    df20 = pd.read_csv("./data/0808_train/treat/2020_202308081741.csv", header=0, sep=',', encoding='gbk')
    df19 = pd.read_csv("./data/0808_train/treat/2019_202308081744.csv", header=0, sep=',', encoding='gbk')
    df18 = pd.read_csv("./data/0808_train/treat/2018_202308081746.csv", header=0, sep=',', encoding='gbk')
    df17 = pd.read_csv("./data/0808_train/treat/2017_202308081749.csv", header=0, sep=',', encoding='gbk')
    df16 = pd.read_csv("./data/0808_train/treat/2016_202308081753.csv", header=0, sep=',', encoding='gbk')

    #df_all = pd.concat([df16, df17, df18, df19, df20, df21, df21, df22, df23])
    df_all = pd.concat([df16])
    print(df16.shape)
    print(df17.shape)
    print(df18.shape)
    print(df19.shape)
    ...
    #network.save('./model/0809_' + type + '_50_20_16_244_fft_p_t_SS_t' + str(n_line_tail) + '_y16_m01_y23_m7_v1.itc')
    network.save('./model/20230821_' + type + '_50_20_16_244_fft_p_t_SS_t' + str(n_line_tail) + '_y16_m01_fl.itc')
