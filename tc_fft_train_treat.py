...
def augment_bad_data_train_treat_continue_for_report():
    usecols = ['CUSTOMER_ID', 'Y', 'RDATE', 'XSZQ30D_DIFF', 'XSZQ90D_DIFF', 'UAR_AVG_365', 'UAR_AVG_180', 'UAR_AVG_90',
    ...
    ###################### for train valid 8:2  bad augment * 50
    df_part1_0 = df_part1[df_part1['Y'] == 0]
    ...
    print('df_part1_1.head:', df_part1_1.head(n_line_head+2))
    print('df_part1_1.shape:', df_part1_1.shape)
    ...
    print('df_part2_1.head:', df_part2_1.head(n_line_head+2))
    print('df_part2_1.shape:', df_part2_1.shape)
...
if __name__ == '__main__':
    ...
    augment_bad_data_train_treat_continue_for_report()