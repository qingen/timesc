...
def weight_vote_occur_static():
    ...
    ks_occur_180 = 0.464
    ks_occur_210 = 0.608
    df201 = pd.read_csv("./result/0826/20230826_occur_M6_y16_m1_y23_m1_result_test_30_fl_35000.csv", header=0, sep=',', encoding='gbk')
    df202 = pd.read_csv("./result/0826/20230826_occur_M6_y16_m1_y23_m1_result_test_60_fl_35000.csv", header=0, sep=',', encoding='gbk')
    df203 = pd.read_csv("./result/0826/20230826_occur_M6_y16_m1_y23_m1_result_test_90_fl_35000.csv", header=0, sep=',', encoding='gbk')
...
def weight_vote_treat_static():
    type = 'treat'
    ks_treat_7 = 0.6650  # 0.6650
    ks_treat_14 = 0.6196  # 0.6196
    ks_treat_21 = 0.6796 # 0.6796
    ks_treat_28 = 0.5499999  # 0.6317  0.00868
    ks_treat_35 = 0.5916666  # 0.5133  0.0225
...
def weight_vote_occur_dynamic_for_report():
    ...
    ks_occur_180 = 0.464
    ks_occur_210 = 0.608
    df201 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_30.csv", header=0, sep=',', encoding='gbk')
    df202 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_60.csv", header=0, sep=',', encoding='gbk')
    df203 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_90.csv", header=0, sep=',', encoding='gbk')
    df204 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_120.csv", header=0, sep=',', encoding='gbk')
    df205 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_150.csv", header=0, sep=',', encoding='gbk')
    df206 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_180.csv", header=0, sep=',', encoding='gbk')
    df207 = pd.read_csv("./result/20230817_occur_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_210.csv", header=0, sep=',', encoding='gbk')
...
def weight_vote_treat_dynamic_for_report():
    ...
    ks_treat_42 = 0.583333
    ks_treat_49 = 0.60
    df201 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_7.csv", header=0, sep=',', encoding='gbk')
    df202 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_14.csv", header=0, sep=',', encoding='gbk')
    df203 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_21.csv", header=0, sep=',', encoding='gbk')
    df204 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_28.csv", header=0, sep=',', encoding='gbk')
    df205 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_35.csv", header=0, sep=',', encoding='gbk')
    df206 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_42.csv", header=0, sep=',', encoding='gbk')
    df207 = pd.read_csv("./result/20230817_treat_M6_y16_m01_y23_m01_y23_m07_result_test_for_report_49.csv", header=0, sep=',', encoding='gbk')
...
def max_vote_occur_static():
    ...
    ks_occur_60 = 0.4516 # 0.432  # 0.4516  0.005017
    ks_occur_90 = 0.45916 # 0.496  # 0.45916 0.003088
