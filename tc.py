...
df23_test = df23_2.groupby(['CUSTOMER_ID']).filter(lambda x: max(x["RDATE"]) >= 20230401)  # 20220401 20220301 20220201 20220101 20211201
print(df23_test.shape)
print('df23_test.shape: ',df23_test.shape)

df_all = pd.concat([df18, df19, df20, df21, df21, df22_1,df22_2,df22_3,df23_1,df23_2])
print(df18.shape)
print(df19.shape)
print(df20.shape)
print(df21.shape)
...
test_num = 200
# 随机选择若干个组
selected_groups = df_all['CUSTOMER_ID'].drop_duplicates().sample(n=test_num, random_state=50)
# 获取每个选中组的所有样本
...
network.save('./model/0802_50_20_16_244_fft_p_t_SS_t'+str(n_line_tail)+'_y18_m01_y23_m7_t'+str(test_num)+'.itc')
...
plt.savefig("0802_y18_m1_y23_m7_ROC_val_" + str(n_line_tail) + "_t"+test_num+"_e50.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("0802_y18_m1_y23_m7_KS_val_" + str(n_line_tail) + "_t"+test_num+"_e50.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("0802_y18_m1_y23_m7_ROC_test_" + str(n_line_tail) + "_t"+test_num+"_e50.png")
plt.show()
plt.plot(tpr, lw=2, label='tpr')
plt.plot(fpr, lw=2, label='fpr')
plt.plot(tpr - fpr, label='ks')
...
plt.legend(loc="lower right")
plt.savefig("0802_y18_m1_y23_m7_KS_test_" + str(n_line_tail) +"_t"+test_num+"_e50.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("0802_y18_m1_y23_m7_ROC_train_" + str(n_line_tail) + "_t"+test_num+"_e50.png")
plt.show()
plt.plot(tpr, lw=2, label='tpr')
plt.plot(fpr, lw=2, label='fpr')
plt.plot(tpr - fpr, label='ks')
...
plt.legend(loc="lower right")
plt.savefig("0802_y18_m1_y23_m7_KS_train_" + str(n_line_tail) + "_t"+test_num+"_e50.png")
plt.show()
