...
def clean_data_train_occur_continue_for_report():
    ...
    n_line_tail = 150  # (1-5) * 30
    n_line_back = 7  # back 7
    n_line_head = 150  # = tail
    type = 'occur'
    ...
    df_part1 = df_part1.groupby(['CUSTOMER_ID']).filter(lambda x: max(x["RDATE"]) < 20230101)  # for train
    ...
    train_0_num_sample = train_1_num_sample * 100
